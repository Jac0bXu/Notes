...
\end{lstlisting}
\section{Graphs}
A graph consists of a set of vertices and edges. Each edge connects two nodes.\\
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[edge_style]  (v2) -- (v3);
        \draw[edge_style]  (v3) -- (v4);
        \draw[edge_style]  (v4) -- (v5);
        \draw[edge_style]  (v5) -- (v6);
        \draw[edge_style]  (v6) -- (v1);
        \draw[edge_style]  (v5) -- (v1);
        \draw[edge_style]  (v5) -- (v2);
        \draw[edge_style]  (v4) -- (v2);
        \draw[edge_style] (v4) to [out=20,in=340,looseness=5] (v4);
    \end{tikzpicture}
\end{center}
On the other hand, a directed graph is that in which each edge has a direction.\\
\begin{center}
    \begin{tikzpicture}
        \tikzstyle{node_style} = [circle,draw=black]
        \tikzstyle{edge_style} = [draw=black]
        ...
        \draw[edge_style] (v4) edge [loop right] ();
    \end{tikzpicture}
\end{center}
