...
\begin{enumerate}
    \item Find all values $\lambda$ such that $\det(\mathbf{A-I}\lambda)=0$. These are your eigenvalues.
    \item For each $\lambda$, find the Null Space of $\mathbf{A-I}\lambda$, that is, find the non-zero vector such that $(\mathbf{A-I}\lambda)\mathbf{x=0}$. Each of these will be your eigenvectors.
\end{enumerate}
