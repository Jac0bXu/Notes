...
Several IDEs exist to run Python, and the one this class will be focusing on is Jupyter Notebook.\\
\subsection{Basic Variables}
Python does not require a declaration command for variables.\\
